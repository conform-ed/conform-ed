...
// dev package with a release peer. External peers (react, zod, …) are a different scope and stay
// ranges; only same-scope siblings are pinned. Handles `workspace:*` and fixed ranges uniformly.
