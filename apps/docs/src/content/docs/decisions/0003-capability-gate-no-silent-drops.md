---
title: "Capability gate: unsupported content is reported, never silently dropped"
description: "Architecture decision record ADR-0003."
sidebar:
  order: 3
  badge: { text: "ADR-0003", variant: note }
---
