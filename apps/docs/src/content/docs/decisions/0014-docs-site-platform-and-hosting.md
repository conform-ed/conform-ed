---
title: "Docs site: Astro Starlight, monorepo source deployed to a dedicated org-pages repo"
description: "Architecture decision record ADR-0014."
sidebar:
  order: 14
  badge: { text: "ADR-0014", variant: note }
---
